...
| Plan states blast radius X | Architect | `diff-impact.py <feature-branch-range>` — surfaced nodes outside the stated scope mean widen the plan or narrow the change |
